...
Scores a project harness across seven subsystems:
  instructions, state, verification, scope, lifecycle, orchestration, structure
...
const result = scoreHarness(files, target);
