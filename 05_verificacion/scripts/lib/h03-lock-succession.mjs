...
export const H03_LOCK_SUCCESSION_REF = 'receipts/dependency-audits/H03-LOCK-SUCCESSION-004.yml';
...
export const verifyApprovedH03LockSuccession = (
  ...
  if (
    ...
    receipt.receipt_id !== 'H03-LOCK-SUCCESSION-004' ||
    receipt.supersedes_receipt_id !== 'H03-LOCK-SUCCESSION-003' ||
