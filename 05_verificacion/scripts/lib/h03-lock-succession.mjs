...
export const H03_LOCK_SUCCESSION_REF = 'receipts/dependency-audits/H03-LOCK-SUCCESSION-017.yml';
const PREVIOUS_SUCCESSION_REF = 'receipts/dependency-audits/H03-LOCK-SUCCESSION-016.yml';
const APPROVAL_PHRASE = 'go';
const APPROVAL_SCOPE = 'frames_consolidation_f13_vendor_locks_gate_without_dependency_change';
...
export const verifyApprovedH03LockSuccession = (
  ...
  if (
    ...
    receipt.receipt_id !== 'H03-LOCK-SUCCESSION-017' ||
