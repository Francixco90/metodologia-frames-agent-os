...
export const H03_LOCK_SUCCESSION_REF = 'receipts/dependency-audits/H03-LOCK-SUCCESSION-012.yml';
const PREVIOUS_SUCCESSION_REF = 'receipts/dependency-audits/H03-LOCK-SUCCESSION-011.yml';
...
export const verifyApprovedH03LockSuccession = (
  ...
  if (
    ...
    receipt.receipt_id !== 'H03-LOCK-SUCCESSION-012' ||
