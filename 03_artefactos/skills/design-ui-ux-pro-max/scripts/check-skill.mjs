...
const id = 'design-ui-ux-pro-max';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/review-button-touch-target.yml`,
  `skills/${id}/fixtures/negative/run-python-search-cli.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/run-python-search-cli.yml`);
