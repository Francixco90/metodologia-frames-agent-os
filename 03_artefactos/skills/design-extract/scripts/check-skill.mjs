...
const id = 'design-extract';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/interpret-normalized-json.yml`,
  `skills/${id}/fixtures/negative/auto-run-extraction.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-run-extraction.yml`);
