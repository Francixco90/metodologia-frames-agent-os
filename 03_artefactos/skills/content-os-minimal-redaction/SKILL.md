...
4. Aplicar en orden: reencuadre periférico temporal, blur gaussiano localizado con máscara
   suavizada, silencio dentro del span con fades internos de 30–60 ms.
...
- `REFRAME_PERIPHERAL` elimina solo la franja acreditada y reescala temporalmente.
