...
const id = 'dev-ponytail-gain';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/show-impact-scoreboard.yml`,
  `skills/${id}/fixtures/negative/auto-run-benchmarks-and-report.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-run-benchmarks-and-report.yml`);
