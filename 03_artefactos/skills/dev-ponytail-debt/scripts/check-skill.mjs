...
const id = 'dev-ponytail-debt';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/harvest-deferral-comments.yml`,
  `skills/${id}/fixtures/negative/auto-write-ledger-file.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-write-ledger-file.yml`);
