...
const id = 'design-canvas-generative';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/particle-pool-flow-field.yml`,
  `skills/${id}/fixtures/negative/auto-run-canvas-loop.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-run-canvas-loop.yml`);
