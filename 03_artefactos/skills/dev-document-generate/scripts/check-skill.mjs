...
const id = 'dev-document-generate';
const required = [
  `skills/${id}/SKILL.md`,
  ...
  `skills/${id}/fixtures/positive/diataxi-full-coverage.yml`,
  `skills/${id}/fixtures/negative/auto-write-files-without-confirmation.yml`,
];
