...
export const routeContentIntent = (input) => {
  ...
  if (selected.includes('P01')) reasons.push('MATERIALS_AVAILABLE');
  if (selected.includes('P02')) reasons.push('EVIDENCE_INSUFFICIENT');
  if (selected.includes('P04')) reasons.push('MULTI_PIECE');
  if (selected.includes('P06')) reasons.push('ASSETS_REQUIRED');
  if (selected.includes('P09')) reasons.push('DISTRIBUTION_REQUESTED');
  return {
