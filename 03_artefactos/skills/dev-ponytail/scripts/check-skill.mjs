...
const id = 'dev-ponytail';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/force-simplest-solution.yml`,
  `skills/${id}/fixtures/negative/add-dependency-for-trivial-task.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/add-dependency-for-trivial-task.yml`);
