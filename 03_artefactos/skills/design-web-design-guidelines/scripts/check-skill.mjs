...
const id = 'design-web-design-guidelines';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/audit-accessibility-contrast.yml`,
  `skills/${id}/fixtures/negative/fetch-guidelines-from-url.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/fetch-guidelines-from-url.yml`);
