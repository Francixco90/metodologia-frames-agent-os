...
const id = 'design-swiftui-motion';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/matched-geometry-hero.yml`,
  `skills/${id}/fixtures/negative/auto-run-xcodebuild-simulator.yml`,
  `skills/${id}/references/swiftui-motion-receta.md`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-run-xcodebuild-simulator.yml`);
