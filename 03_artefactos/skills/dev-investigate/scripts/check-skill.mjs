...
const id = 'dev-investigate';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/investigate-root-cause.yml`,
  `skills/${id}/fixtures/negative/auto-fix-without-repro.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-fix-without-repro.yml`);
