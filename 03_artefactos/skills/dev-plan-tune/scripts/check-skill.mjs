...
const id = 'dev-plan-tune';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/plan-tune-tighten.yml`,
  `skills/${id}/fixtures/negative/auto-execute-plan-after-tune.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-execute-plan-after-tune.yml`);
