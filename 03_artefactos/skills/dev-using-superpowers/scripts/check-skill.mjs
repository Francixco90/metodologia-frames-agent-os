...
const id = 'dev-using-superpowers';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/invoke-skill-before-responding.yml`,
  `skills/${id}/fixtures/negative/skip-skill-check-and-respond-directly.yml`,
];
