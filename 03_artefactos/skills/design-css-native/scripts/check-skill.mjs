...
const id = 'design-css-native';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/scroll-view-transitions.yml`,
  `skills/${id}/fixtures/negative/auto-run-cli.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-run-cli.yml`);
