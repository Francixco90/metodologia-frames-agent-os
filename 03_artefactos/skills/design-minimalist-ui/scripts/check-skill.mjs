...
const id = 'design-minimalist-ui';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/editorial-workspace-bento.yml`,
  `skills/${id}/fixtures/negative/gradient-shadow-slop.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/gradient-shadow-slop.yml`);
