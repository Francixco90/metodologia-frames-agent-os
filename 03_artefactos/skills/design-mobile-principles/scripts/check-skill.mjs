...
const id = 'design-mobile-principles';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/gesture-snap-back.yml`,
  `skills/${id}/fixtures/negative/small-touch-target.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/small-touch-target.yml`);
