...
const id = 'dev-careful';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/careful-destructive-migration.yml`,
  `skills/${id}/fixtures/negative/auto-force-push.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-force-push.yml`);
