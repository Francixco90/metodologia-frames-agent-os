...
const required = [
  ...
  `skills/${id}/fixtures/positive/spec-from-vague-request.yml`,
  `skills/${id}/fixtures/negative/skip-spec-auto-implement.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/skip-spec-auto-implement.yml`);
