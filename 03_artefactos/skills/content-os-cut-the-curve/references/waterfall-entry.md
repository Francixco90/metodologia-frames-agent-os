# Waterfall Entry (in-scene arrival — not a seam)
...
the waterfall cut; do not mix their rules:

|               | Entry (arrival)                               | Waterfall Cut (seam)                                     |
| ------------- | --------------------------------------------- | -------------------------------------------------------- |
...
- Post-settle, the group usually slides to make room for the next beat — that's nudge curve.