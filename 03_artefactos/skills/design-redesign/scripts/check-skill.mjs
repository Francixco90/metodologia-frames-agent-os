...
const id = 'design-redesign';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/audit-existing-saas.yml`,
  `skills/${id}/fixtures/negative/rewrite-from-scratch.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/rewrite-from-scratch.yml`);
