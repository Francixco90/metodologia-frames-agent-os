...
const required = [
  ...
  `skills/${id}/fixtures/positive/freeze-checkpoint-before-refactor.yml`,
  `skills/${id}/fixtures/negative/auto-git-stash-after-freeze.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-git-stash-after-freeze.yml`);
