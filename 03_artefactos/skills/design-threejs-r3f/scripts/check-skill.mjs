...
const id = 'design-threejs-r3f';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/instanced-mesh-orbit.yml`,
  `skills/${id}/fixtures/negative/auto-run-vite-dev.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-run-vite-dev.yml`);
