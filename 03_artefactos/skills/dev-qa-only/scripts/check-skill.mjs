...
const id = 'dev-qa-only';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/qa-only-criteria-pass.yml`,
  `skills/${id}/fixtures/negative/qa-only-with-suggestions.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/qa-only-with-suggestions.yml`);
