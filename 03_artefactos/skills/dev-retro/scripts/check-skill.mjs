...
const required = [
  ...
  `skills/${id}/fixtures/positive/sprint-retro-action-items.yml`,
  `skills/${id}/fixtures/negative/blameful-retro.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/blameful-retro.yml`);
