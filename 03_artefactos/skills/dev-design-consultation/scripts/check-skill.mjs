...
const id = 'dev-design-consultation';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/design-consultation-propose-system.yml`,
  `skills/${id}/fixtures/negative/auto-execute-git-after-design.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-execute-git-after-design.yml`);
