...
const id = 'design-frontend-design';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/distinctive-hero-thesis.yml`,
  `skills/${id}/fixtures/negative/templated-default-palette.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/templated-default-palette.yml`);
