...
const id = 'design-motion-principles';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/enter-exit-symmetric.yml`,
  `skills/${id}/fixtures/negative/animate-layout-props.yml`,
  `skills/${id}/references/motion-principles-receta.md`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/animate-layout-props.yml`);
