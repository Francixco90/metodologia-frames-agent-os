...
function bind(root) {
  ...
  edit(resolve(root, 'source-analysis.json'), (value) => { value.sources.push(
    {sourceId: 'wrapper-body-a', sourceSha256: sha(bodyA), rights: 'synthetic', authority: 'primary', probe: {status: 'passed', mediaType: 'video', durationMs: bodyMedia.durationMs, hasAudio: true, width: bodyMedia.width, height: bodyMedia.height, fps: bodyMedia.fps, orientation: 'portrait'}, audioClassification: 'music-sfx', asrAttempt: {status: 'no-speech-detected', reason: 'synthetic tone fixture'}, transcriptIntelligence: {status: 'not-applicable', reason: 'no speech detected'}, sampleTimesMs: [0], watermarkObservations: [{sampleTimeMs: 0, present: false, points: []}], cropSafety: {safe: true, strategy: 'contain', coveredSampleTimesMs: [0], evidence: []}, editorialDecision: 'use', state: 'ready'},
    {sourceId: 'wrapper-body-b', sourceSha256: sha(bodyB), rights: 'synthetic', authority: 'primary', probe: {status: 'passed', mediaType: 'video', durationMs: bodyMedia.durationMs, hasAudio: true, width: bodyMedia.width, height: bodyMedia.height, fps: bodyMedia.fps, orientation: 'portrait'}, audioClassification: 'music-sfx', asrAttempt: {status: 'no-speech-detected', reason: 'synthetic tone fixture'}, transcriptIntelligence: {status: 'not-applicable', reason: 'no speech detected'}, sampleTimesMs: [0], watermarkObservations: [{sampleTimeMs: 0, present: false, points: []}], cropSafety: {safe: true, strategy: 'contain', coveredSampleTimesMs: [0], evidence: []}, editorialDecision: 'use', state: 'ready'},
  ); return value; });
