...
function audible(root) {
  edit(resolve(root, 'source-analysis.json'), (value) => { const source = value.sources[0]; Object.assign(source, {probe: {status: 'passed', mediaType: 'video', durationMs: 1250, hasAudio: true, width: 108, height: 192, fps: 24, orientation: 'portrait'}, audioClassification: 'speech', asrAttempt: {status: 'candidate', candidateRef: 'captions.json', candidateSha256: sha(resolve(root, 'captions.json'))}, transcriptIntelligence: {status: 'deterministic-passed', verificationRef: 'correction-ledger.json', verificationSha256: sha(resolve(root, 'correction-ledger.json'))}}); return value; });
}
