...
const required = [
  ...
  `skills/${id}/fixtures/positive/analyze-reference-to-json.yml`,
  `skills/${id}/fixtures/negative/auto-fetch-url-no-confirm.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-fetch-url-no-confirm.yml`);
