...
const id = 'design-impeccable';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/critique-landing-hierarchy.yml`,
  `skills/${id}/fixtures/negative/invoke-external-cli.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/invoke-external-cli.yml`);
