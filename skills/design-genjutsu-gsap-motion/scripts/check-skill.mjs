...
const id = 'design-genjutsu-gsap-motion';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/scrolltrigger-timeline-stagger.yml`,
  `skills/${id}/fixtures/negative/auto-install-gsap-npm.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-install-gsap-npm.yml`);
