...
const id = 'design-genjutsu-uiux';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/palette-typography-recommendation.yml`,
  `skills/${id}/fixtures/negative/auto-run-design-cli.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-run-design-cli.yml`);
