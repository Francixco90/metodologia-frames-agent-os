...
const id = 'dev-plan-devex-review';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/plan-devex-review-walkthrough.yml`,
  `skills/${id}/fixtures/negative/auto-merge-plan-skipping-devex.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-merge-plan-skipping-devex.yml`);
