...
const id = 'dev-ponytail-audit';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/audit-repo-for-over-engineering.yml`,
  `skills/${id}/fixtures/negative/auto-delete-after-audit.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-delete-after-audit.yml`);
