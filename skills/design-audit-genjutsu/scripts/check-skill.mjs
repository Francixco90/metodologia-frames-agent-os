...
const id = 'design-audit-genjutsu';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/audit-motion-gaps.yml`,
  `skills/${id}/fixtures/negative/auto-run-pa11y.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-run-pa11y.yml`);
