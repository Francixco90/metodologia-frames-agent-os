...
const id = 'dev-ponytail-review';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/review-for-over-engineering.yml`,
  `skills/${id}/fixtures/negative/auto-delete-code-without-confirmation.yml`,
];
