...
const id = 'dev-plan-eng-review';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/plan-eng-review-walkthrough.yml`,
  `skills/${id}/fixtures/negative/auto-land-plan-without-review.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-land-plan-without-review.yml`);
