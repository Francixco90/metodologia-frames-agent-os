...
const id = 'design-high-end-visual';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/premium-portfolio-double-bezel.yml`,
  `skills/${id}/fixtures/negative/default-font-shadow.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/default-font-shadow.yml`);
