...
const id = 'design-framer-motion';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/animate-presence-exit.yml`,
  `skills/${id}/fixtures/negative/unstable-key.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/unstable-key.yml`);
