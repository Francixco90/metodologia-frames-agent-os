...
const id = 'dev-dispatching-parallel-agents';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/parallel-dispatch-independent-domains.yml`,
  `skills/${id}/fixtures/negative/auto-dispatch-mutation-agents-without-confirmation.yml`,
];
