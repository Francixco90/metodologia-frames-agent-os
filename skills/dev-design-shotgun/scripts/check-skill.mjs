...
const id = 'dev-design-shotgun';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/divergent-explore-three-directions.yml`,
  `skills/${id}/fixtures/negative/auto-commit-approved-variant.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-commit-approved-variant.yml`);
