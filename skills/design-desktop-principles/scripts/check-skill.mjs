...
const id = 'design-desktop-principles';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/hover-state-feedback.yml`,
  `skills/${id}/fixtures/negative/auto-run-electron-build.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-run-electron-build.yml`);
