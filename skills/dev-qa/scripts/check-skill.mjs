...
const required = [
  ...
  `skills/${id}/fixtures/positive/qa-review-pr-diff.yml`,
  `skills/${id}/fixtures/negative/auto-merge-without-review.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-merge-without-review.yml`);
