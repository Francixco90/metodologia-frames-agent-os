...
const id = 'design-compose-graphics';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/canvas-brush-gradient.yml`,
  `skills/${id}/fixtures/negative/auto-run-gradle.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-run-gradle.yml`);
