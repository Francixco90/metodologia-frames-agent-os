...
const id = 'dev-using-git-worktrees';
const required = [
  `skills/${id}/SKILL.md`,
  `skills/${id}/LINEAGE.yml`,
  `skills/${id}/scripts/check-skill.mjs`,
  `skills/${id}/receipts/runtime-boundary.yml`,
  `skills/${id}/fixtures/positive/isolate-feature-work.yml`,
  `skills/${id}/fixtures/negative/auto-create-worktree-without-confirmation.yml`,
];
