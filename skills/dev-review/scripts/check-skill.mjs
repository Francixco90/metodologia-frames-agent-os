...
const required = [
  ...
  `skills/${id}/fixtures/positive/review-change-diff.yml`,
  `skills/${id}/fixtures/negative/auto-commit-on-behalf.yml`,
];
...
const negative = contents.get(`skills/${id}/fixtures/negative/auto-commit-on-behalf.yml`);
