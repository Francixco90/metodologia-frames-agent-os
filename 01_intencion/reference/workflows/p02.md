...
| S03  | Materializar Opportunity Map V2 y derivar su proyección V1 exacta. | `content-os-core`     | opportunity-map-v1 | `G14`      |
...
sequenceDiagram
  ...
  a3_RT_09->>a1_Frames: Gate G14
  a1_Frames->>a2_content_os_core: S03 - Materializar Opportunity Map V2 y derivar su proyección V1 exacta.
