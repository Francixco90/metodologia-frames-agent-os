...
Este cambio materializa `Operator Core` y prepara bindings explícitos para R6/R7.
El enlace del router y el benchmark con ejecuciones reales se validan como
incrementos separados para evitar una migración monolítica. [METODOLOGIA]
