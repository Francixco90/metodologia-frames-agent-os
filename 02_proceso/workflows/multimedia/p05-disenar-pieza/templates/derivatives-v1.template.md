...
instance_id: DELIV-P05-DERIVATIVES
deliverable_id: derivatives-v1
display_name: Sistema de derivados · Template
workflow_id: P05
...
audience: Content manager y productores.
purpose: Derivar formatos y canales desde una pieza matriz preservando claims, identidad y lineage.
sources:
...
fields:
  - field_id: master-piece
    label: master-piece
    value_type: text
    status: unknown
    value: ⟦UNKNOWN:master-piece⟧
    source_refs: []
  - field_id: derivative
    label: derivative
    value_type: text
    status: unknown
    value: ⟦UNKNOWN:derivative⟧
    source_refs: []
  - field_id: transformation
    label: transformation
    value_type: text
    status: unknown
    value: ⟦UNKNOWN:transformation⟧
    source_refs: []
  - field_id: invariant
    label: invariant
    value_type: text
    status: unknown
    value: ⟦UNKNOWN:invariant⟧
    source_refs: []
  - field_id: channel
    label: channel
    value_type: text
...
Derivar formatos y canales desde una pieza matriz preservando claims, identidad y lineage. Decisión pendiente en G14; este DRAFT no concede aprobación.

## Audiencia y uso

Precisar quién usa el entregable, para qué decisión y quién lo consume después.

Content manager y productores. Consumidores: P06, P07. Foco: medio, narrativa, continuidad, mapa de activos y especificación producible.
...
- master-piece: ⟦UNKNOWN:master-piece⟧
...
Campos: master-piece, derivative, transformation, invariant, channel, acceptance. Gate: G14.
