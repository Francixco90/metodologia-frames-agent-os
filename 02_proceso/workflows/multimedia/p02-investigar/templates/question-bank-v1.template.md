...
instance_id: DELIV-P02-QUESTION-BANK
deliverable_id: question-bank-v1
display_name: Banco de preguntas · Template
workflow_id: P02
...
audience: Investigador y cliente.
purpose: Conservar preguntas abiertas, impacto, owner, fuente esperada y stop rule.
sources:
...
fields:
  ...
  - field_id: owner
    ...
    value: ⟦UNKNOWN:owner⟧
    source_refs: []
  - field_id: expected-source
    label: expected-source
    value_type: text
    status: unknown
    value: ⟦UNKNOWN:expected-source⟧
    source_refs: []
  - field_id: due-gate
    label: due-gate
    value_type: text
    status: unknown
    value: ⟦UNKNOWN:due-gate⟧
    source_refs: []
  - field_id: status
    label: status
    value_type: text
...
state: DRAFT
next_gate: G14
content_sha256: 7490f59742016e44b2393deab4d974d655f96340f30ca888641cb2539fac0fa2
---
...
Conservar preguntas abiertas, impacto, owner, fuente esperada y stop rule. Decisión pendiente en G14; este DRAFT no concede aprobación.

## Audiencia y uso

Precisar quién usa el entregable, para qué decisión y quién lo consume después.

Investigador y cliente. Consumidores: P02, P03, human. Foco: preguntas, claims, evidencia, límites y oportunidades justificadas.

## Entradas, evidencia y supuestos

Distinguir inputs declarados, evidencia material, supuestos y gaps bloqueantes.

Inputs: digest-shortlist-v1. Separar evidencia observada, inferencia y preguntas todavía abiertas.
...
- owner: ⟦UNKNOWN:owner⟧
- expected-source: ⟦UNKNOWN:expected-source⟧
- due-gate: ⟦UNKNOWN:due-gate⟧
...
Formatos: md, html. Familias: other. Foco: preguntas, claims, evidencia, límites y oportunidades justificadas.

## Secuencia, hitos y dependencias

Vincular los pasos productores, sus dependencias y sus condiciones de parada.

- S01: Formular preguntas verificables desde el shortlist. Stop: Detener si la pregunta no puede vincularse a una decisión editorial.

## Skills, ownership y handoffs

Declarar skill principal, apoyos, verifier y consumidores del handoff.

- S01: owner content-os-core; apoyos content-os-registry; verifier RT-09.
...
Campos: question, impact, owner, expected-source, due-gate, status. Gate: G14.

## Estado, lineage y siguiente gate

Conservar DRAFT, lineage del workflow y siguiente gate sin autoaprobar.

P02 → P02, P03, human. DRAFT; gate G14.
