...
| `creation-v3-skill-registry.yml`                  | 12                                                        | `check-creation-v3-skills.ts`  |
...
`pnpm verify:skills` encadena los dos checks. Solo 5 V2 + 12 H03 estan hash-validados; v1 `remotion-video-production` y `stitch` no. [CÓDIGO]
